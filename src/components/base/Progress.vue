<template>
	<div ref="progressBox" class="progressBox" :style="progressBoxStyle" @mousemove="setTooltip"
		@mouseleave="progressBoxLeave" @click="changeProgressBar">
		<!-- 进度条 -->
		...
		<transition name="el-fade-in-linear">
			<div class="radiusBtn" ref="radiusBtn" :style="radiusBtnStyle"
				v-show="showRadiusBtn ? showRadiusBtn : hoverShowRadiusBtn" @mouseenter="radiusBtnHover"
				@mouseleave="radiusBtnLeave" @mousedown="dragProgressBar"></div>
		</transition>
		<!--提示框  -->
		<transition name="el-fade-in-linear">
			<div class="tooltip" ref="tooltip" :style="{ bottom: `${progressSize + 10}px` }"
