		...
		<div class="tags">
			...
			<transition name="el-fade-in">
				<div class="all-tag-list" v-show="isShow">
					<div class="all-tag">
						<div class="all-tag-item" v-for="(item, index) in allTag" :key="index"
			...
			<!-- 热门标签 -->
			<div class="hot-tag">
				<div class="hot-tag-item" v-for="(item, index) in hotTag" :key="index"
					@click="tagClickH(item.name, index, item.id)" :class="{ activeHot: currentIndexH == index }">
					{{ item.name }}
				</div>
			</div>
		</div>
