<template>
	<div class="float-lyric" :class="{ bg: isShowBg }" ref="lyric" @mousedown="dragLyric" @mouseover="isShowBg = true"
		@mouseleave="isShowBg = false">
		<div class="lyric">
			<!-- 关闭按钮 -->
			...
			<div id="floatLyric" ref="floatLyric" v-else>
				<div class="lyricRow" v-for="(item, index) in currentLyric" :key="index"
